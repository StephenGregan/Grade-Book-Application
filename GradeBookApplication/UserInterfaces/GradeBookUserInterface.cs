...
namespace GradeBookApplication.UserInterfaces
{
    public static class GradeBookUserInterface
    {
        ...
        public static void CommandRoute(string command)
        {
            ...
            else if (command == "statistices all")
            {
                StatisticsCommand();
            }
        ...
        public static void AddGradeCommand(string command)
        {
            ...
            if (parts.Length != 3)
            {
                Console.WriteLine("Command not valid, AddGrade requires a name and a score.");
                return;
            }
            var name = parts[1];
        ...
        public static void RemoveGradeCommand(string command)
        {
            ...
            if (parts.Length != 3)
            {
                Console.WriteLine("Command not valid, Removegrade requires a name and a score.");
                return;
            }
            var name = parts[1];
            var score = Double.Parse(parts[2]);
            GradeBook.RemoveGrade(name, score);
            Console.WriteLine("Remove a score of {0} from {1}'s grades",score, name);
        }
        ...
        public static void AddStudentCommand(string command)
        {
            ...
            {
                Console.WriteLine("{0} is not a valid student type, please try again.", parts[2]);
                return;
            }
            ...
            {
                Console.WriteLine("{0} is not a valid enrollment type, please try again", parts[3]);
                return;
            }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Add 'Name' 'Student Type' 'Enrollmet Type' - Adds a new student to the gradebook with the provided name, type of student and type of enrollment.");
            Console.WriteLine();
            Console.WriteLine("Accepted student types:");
            Console.WriteLine("Standard - Student not enrolled in Honours classes or Dual Enrollment.");
            Console.WriteLine("Honours - Student enrolled in Honours classes and not in Dual Enrollment.");
            Console.WriteLine("DualEnrolled - Students who are Dual Enrollment.");
            Console.WriteLine();
            ...
            Console.WriteLine("State - Students who's legal residence is ourside of the schools disctrict, but is in the same state as the school.");
            ...
            Console.WriteLine("International - Studentws who's legal residence is not in the same country ad the school.");
            Console.WriteLine();
